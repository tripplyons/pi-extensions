...
| [model-fusion](extensions/model-fusion/README.md) | Combines a Luna actor, reviews every 10 tool-use turns and at completion, and bounded Astra advice, including goal-loop checks. Enable with `/fusion on`. |
