...
const harness = async (config?: string) => {
	...
	const registry: Registry = {
		...
		getProvider: () => ({ streamSimple: (model, _context, _options) => {
	...
	return { dir, commands, handlers, providers, tools, registry, get calls() { return calls; } };
};
