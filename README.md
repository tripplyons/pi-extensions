...
23 extensions for [Pi](https://pi.dev/): Codex conversion and 22 local extensions. Use native Pi file tools and bg-bash with Codex tool overrides disabled.
...
| [mixture](extensions/mixture/README.md) | A lead/writer model with bounded phase state, enforceable handoffs, deduplicated checkpoints, read-only review, and a compact status. |
